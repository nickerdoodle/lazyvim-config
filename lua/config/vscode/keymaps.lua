...
-- lazynvim not using packer right now so comment out for vscode to work
...
vim.keymap.set("n", "gD", function()
  vim.fn.VSCodeNotify("editor.action.goToDeclaration")
end)
...
vim.keymap.set("n", "<leader>tn", function()
  vim.fn.VSCodeNotify("workbench.action.terminal.newInActiveWorkspace")
end)
vim.keymap.set("n", "<leader>tk", function()
  vim.fn.VSCodeNotify("workbench.action.terminal.kill")
end)

vim.keymap.set("n", "<leader>tc", function()
  vim.cmd("norm viw")
  -- vim.fn.VSCodeNotifyVisual("turboConsoleLog.displayLogMessage", true)
  vim.fn.VSCodeNotify("turboConsoleLog.displayLogMessage", true)
  vim.cmd("norm <Esc>")
end)
...
vim.keymap.set("n", "?", function()
  vim.cmd("norm viw")
  -- vim.fn.VSCodeNotifyVisual("workbench.action.findInFiles", true)
  vim.fn.VSCodeNotify("workbench.action.findInFiles", true)
end)
...
vim.keymap.set("v", "<leader><leader>r", function()
  -- vim.fn.VSCodeNotifyVisual("workbench.action.replaceInFiles", true)
  vim.fn.VSCodeNotify("workbench.action.replaceInFiles", true)
end)

vim.keymap.set("v", "<leader><leader>C", function()
  -- vim.fn.VSCodeNotifyVisual("editor.action.clipboardCopyAction", true)
  vim.fn.VSCodeNotify("editor.action.clipboardCopyAction", true)
end)
...
vim.keymap.set("n", "zp", function()
  vim.fn.VSCodeNotify("editor.gotoParentFold", true)
end)
vim.keymap.set("n", "zf", function()
  vim.fn.VSCodeNotify("editor.toggleFold", true)
end)
vim.keymap.set("n", "za", function()
  vim.fn.VSCodeNotify("editor.foldAll", true)
end)

-- comment out to test cursor
